...
% the temperature
%***** this function currently uses curve fits to find properties data tables nist method or some other method might be better**
%
% Inputs:
% Input 1 - Temperature
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [o] = nitrous_properties(T)
...
%source (HRAP taking for granted rn need source for this)******************** 
a1 = -6.71893;
a2 = 1.35966;
a3 = -1.3779;
a4 = -4.051;
%vapor pressure (Pa)
o.P_v = P_crit*exp((1/(T/T_crit))*(a1*(1-T/T_crit) + ...
...
o.rho_l = rho_crit*exp(b1*(1-(T/T_crit))^(1/3) + ...
...
o.rho_v = rho_crit*exp(c1*((T_crit/T)-1)^(1/3) + ...
...
o.delta_H = (e1-d1) + (e2-d2)*(1-(T/T_crit))^(1/3) + (e3-d3)* ...
